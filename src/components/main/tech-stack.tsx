...
export function TechStack() {
  return (
    <div
      id="stack"
      dir="ltr"
      className="relative scroll-mt-14 bg-transparent border-t border-b py-3 flex w-full flex-col items-center justify-center overflow-hidden"
    >
      ...
      <Marquee
        reverse
        pauseOnHover
        className="[--duration:22s] [--gap:1rem] py-2"
      >
        {backend.map((tech) => (
